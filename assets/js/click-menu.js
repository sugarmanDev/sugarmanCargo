...
mobileMenu += "<ul>";
mobileMenu += '<li><a href="/pages/branch/branch_list.html">지점찾기</a></li>';
mobileMenu += '<li><a href="/pages/franchise/franchise.html">가맹안내</a></li>';
mobileMenu += "</ul>";
mobileMenu += '<a href="/pages/visit.html">';
